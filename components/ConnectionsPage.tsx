    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <main className="lg:ml-64 min-h-screen py-8 px-4 sm:px-6 lg:px-10 pt-16 lg:pt-8">
        <div className="py-6">
          ...
          {/* Pagination */}
          {!loading && connections.length > 0 && pagination.totalPages > 1 && (
          ...
          {!loading && connections.length > 0 && (
            <div className="mt-4 text-center text-sm text-gray-500">
              Showing {((currentPage - 1) * pagination.pageSize) + 1} to {Math.min(currentPage * pagination.pageSize, pagination.total)} of {pagination.total} connections
            </div>
          )}
        </div>
      </main>
